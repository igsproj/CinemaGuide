;(function () {
  ...
  function u(a, b) {
    if (b)
      a: {
        ...
        d = c[a]
        b = b(d)
        b != d && b != null && r(c, a, { configurable: !0, writable: !0, value: b })
      }
  }
  u('Symbol', function (a) {
    function b(k) {
  ...
  u('Promise', function (a) {
    ...
    b.prototype.A = function (e, f) {
      if (this.h != 0)
        throw Error(
          'Cannot settle(' + e + ', ' + f + '): Promise already settled in state' + this.h
        )
      this.h = e
      this.i = f
      this.h === 2 && this.K()
    ...
    b.all = function (e) {
      ...
      return h.done
        ...
        : new b(function (l, m) {
            ...
            var p = [],
              A = 0
            do p.push(void 0), A++, d(h.value).B(n(p.length - 1), m), (h = f.next())
            while (!h.done)
          })
    }
    return b
    ...
    typeof Object.assign == 'function'
      ...
      : function (a, b) {
          for (var c = 1; c < arguments.length; c++) {
            var d = arguments[c]
            if (d) for (var g in d) F(d, g) && (a[g] = d[g])
          }
          return a
        }
  ...
  u('Map', function (a) {
    ...
    function d(f, h) {
      ...
      if (m && F(f[0], l))
        for (f = 0; f < m.length; f++) {
          var n = m[f]
          if ((h !== h && n.key !== n.key) || h === n.key) return { id: l, list: m, index: f, o: n }
        }
    ...
    g.prototype.set = function (f, h) {
      ...
      l.o
        ? (l.o.value = h)
        : ((l.o = { next: this[1], previous: this[1].previous, head: this[1], key: f, value: h }),
          l.list.push(l.o),
    ...
    if (
      (function () {
        ...
        try {
          ...
          k = g.next()
          return k.done || k.value[0] == c || k.value[0].x != 4 || k.value[1] != k.value[0]
            ? !1
            : g.next().done
        } catch (e) {
          return !1
  ...
  u('Array.from', function (a) {
    return a
      ...
      : function (b, c, d) {
          ...
          } else for (k = b.length, e = 0; e < k; e++) g.push(c.call(d, b[e], e))
          return g
        }
  })
...
*/
  ...
  function hb() {
    for (
      var a = R(), b = RegExp('([A-Z][\\w ]+)/([^\\s]+)\\s*(?:\\((.*?)\\))?', 'g'), c = [], d;
      (d = b.exec(a));
  ...
  q.D = function (a) {
    ...
    if (b) {
      ...
      this.m != 0
        ...
        : (c && wa(c, a), delete this.g[a], delete this.g[a + 1], delete this.g[a + 2])
    }
    return !!b
  }
  q.G = function (a, b) {
    ...
    if (c) {
      ...
      if (this.A) for (k = 0; k < c.length; k++) (g = c[k]), kb(this.g[g + 1], this.g[g + 2], d)
      else {
        this.m++
        try {
          ...
          if ((this.m--, this.l.length > 0 && this.m == 0)) for (; (c = this.l.pop()); ) this.D(c)
        }
      }
      return k != 0
    }
  ...
  function nb(a, b, c) {
    if (Array.isArray(b)) for (var d = 0; d < b.length; d++) nb(a, String(b[d]), c)
            ...
            Promise.all(
              b.map(function (d) {
                ...
                return oa(function (k) {
                  ...
                  k.g != 2
                    ? ((g = k.m), g.state === 'prompt' && a.g.push(d), (k.g = 0), (k.l = 0))
                    : ((k.l = 0), (k.i = null), (k.g = 0))
                })
              })
            ),
            4
  ...
  function Bb(a, b) {
    ...
    W.yt_embedsEnableIframeApiSendFullEmbedUrl &&
      (window.location.href && (e.forigin = window.location.href),
    ...
    W.yt_embedsEnableIframeSrcWithIntent
      ? (Ya(c, Ua(a)), c.sandbox.add('allow-presentation', 'allow-top-navigation'))
      : (c.src = a)
    return c
  }
  q.F = function () {
  ...
  function Gb(a) {
    ...
    window !== window.top &&
      document.referrer &&
      (b.widget_referrer = document.referrer.substring(0, 256))
  ...
  function Mb(a) {
    if (a.tagName.toLowerCase() !== 'iframe') {
      var b = xb(a, 'videoid')
      b && ((b = { videoId: b, width: xb(a, 'width'), height: xb(a, 'height') }), new X(a, b))
    }
  }
  function Ib(a, b, c) {
    Z ||
          ...
          if (k && d.origin === k.N)
            switch (
              ...
              case 'apiInfoDelivery':
                if (H(g)) for (var e in g) g.hasOwnProperty(e) && (d.v[e] = g[e])
                break
              case 'infoDelivery':
                Jb(d, g)
                break
              case 'initialDelivery':
                ...
                break
              default:
                d.i.i || ((e = { target: d, data: g }), d.i.G(k, e), yb('player.' + k, e))
            }
        }
      }))
    Z[b] = { U: a, N: c }
